...
for i in range(ITER):
    ...
    W3 = common.update_W(a2, b3, z3, W3, u, rho)
    a2 = common.update_a(W3, b3, z3, z2, a2, u, 0,rho)
    z2 = common.update_z(a1, W2, b2, a2, z2, 0, 0,rho)
    b2 = common.update_b(a1, W2, z2, b2, 0, rho)
    W2 = common.update_W(a1, b2, z2, W2, 0, rho)
    a1 = common.update_a(W2, b2, z2, z1, a1, 0, 0,rho)
    z1 = common.update_z(x_train, W1, b1, a1, z1, 0, 0,rho)
    b1 = common.update_b(x_train, W1, z1, b1, 0, rho)
    W1 = common.update_W(x_train, b1, z1, W1, 0,rho)
    W1 = common.update_W(x_train, b1, z1, W1, 0,rho)
    b1 = common.update_b(x_train, W1, z1, b1, 0,rho)
    z1 = common.update_z(x_train, W1, b1, a1,z1,0,0,rho)
    a1 = common.update_a(W2, b2, z2, z1, a1, 0,0,rho)
